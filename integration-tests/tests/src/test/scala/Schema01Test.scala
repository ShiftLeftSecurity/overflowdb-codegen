...
class Schema01Test extends AnyWordSpec with Matchers {
  ...
  "working with a concrete sample graph" can {
    ...
    "lookup and traverse nodes/edges/properties" in {
      ...
      node1Traversal.head.edge1Out.l shouldBe Seq(node2)
      node1Traversal.head._node2ViaEdge1Out.l shouldBe Seq(node2)
      node1Traversal.head._node2ViaEdge2In shouldBe node2
    }
  }
