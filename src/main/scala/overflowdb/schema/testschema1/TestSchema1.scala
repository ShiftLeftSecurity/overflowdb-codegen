...
object TestSchema1 extends App {
  ...
  val frameworks = builder.addConstants(category = "Frameworks",
    Constant(name = "SPRING", value = "SPRING", valueType = "String",
      comment = "Java spring framework"),
    Constant(name = "ASP_NET_MVC", value = "ASP_NET_MVC", valueType = "String",
      comment = "Microsoft ASP.NET MVC"),
    Constant(name = "JAXWS", value = "JAXWS", valueType = "String",
      comment = "JAX-WS"),
    Constant(name = "JAVA_INTERNAL", value = "JAVA_INTERNAL", valueType = "String",
      comment = "Framework facilities directly provided by Java"),
    Constant(name = "ASP_NET_WEB_UI", value = "ASP_NET_WEB_UI", valueType = "String",
      comment = "Microsoft ASP.NET Web UI"),
    Constant(name = "JAXRS", value = "JAXRS", valueType = "String",
      comment = "JAX-RS"),
    Constant(name = "DROPWIZARD", value = "DROPWIZARD", valueType = "String",
      comment = "Dropwizard framework"),
    Constant(name = "PLAY", value = "PLAY", valueType = "String",
      comment = "Play framework"),
    Constant(name = "SPARK", value = "SPARK", valueType = "String",
      comment = "Spark micro web framework"),
    Constant(name = "VERTX", value = "VERTX", valueType = "String",
      comment = "Polyglot event-driven framework"),
    Constant(name = "JSF", value = "JSF", valueType = "String",
      comment = "JavaServer Faces"),
    Constant(name = "ASP_NET_WEB_API", value = "ASP_NET_WEB_API", valueType = "String",
      comment = "Microsoft ASP.NET Web API"),
    Constant(name = "WCF", value = "WCF", valueType = "String",
      comment = "WCF HTTP and REST"),
    Constant(name = "GWT", value = "GWT", valueType = "String",
      comment = "Google web toolkit"),
    Constant(name = "SERVLET", value = "SERVLET", valueType = "String",
      comment = "Java Servlet based frameworks"),
    Constant(name = "ASP_NET_CORE", value = "ASP_NET_CORE", valueType = "String",
      comment = "Microsoft ASP.NET Core"),
  )

  val languages = builder.addConstants(category = "Languages",
    Constant(name = "JAVA", value = "JAVA", valueType = "String",
      comment = ""),
    Constant(name = "JAVASCRIPT", value = "JAVASCRIPT", valueType = "String",
      comment = ""),
    Constant(name = "GOLANG", value = "GOLANG", valueType = "String",
      comment = ""),
    Constant(name = "CSHARP", value = "CSHARP", valueType = "String",
      comment = ""),
    Constant(name = "C", value = "C", valueType = "String",
      comment = ""),
    Constant(name = "PYTHON", value = "PYTHON", valueType = "String",
      comment = ""),
    Constant(name = "LLVM", value = "LLVM", valueType = "String",
      comment = ""),
    Constant(name = "PHP", value = "PHP", valueType = "String",
      comment = ""),
  )

  val modifierTypes = builder.addConstants(category = "ModifierTypes",
    Constant(name = "STATIC", value = "STATIC", valueType = "String",
      comment = "The static modifier"),
    Constant(name = "PUBLIC", value = "PUBLIC", valueType = "String",
      comment = "The public modifier"),
    Constant(name = "PROTECTED", value = "PROTECTED", valueType = "String",
      comment = "The protected modifier"),
    Constant(name = "PRIVATE", value = "PRIVATE", valueType = "String",
      comment = "The private modifier"),
    Constant(name = "ABSTRACT", value = "ABSTRACT", valueType = "String",
      comment = "The abstract modifier"),
    Constant(name = "NATIVE", value = "NATIVE", valueType = "String",
      comment = "The native modifier"),
    Constant(name = "CONSTRUCTOR", value = "CONSTRUCTOR", valueType = "String",
      comment = "The constructor modifier"),
    Constant(name = "VIRTUAL", value = "VIRTUAL", valueType = "String",
      comment = "The virtual modifier"),
  )

  val evaluationStrategies = builder.addConstants(category = "EvaluationStrategies",
    Constant(name = "BY_REFERENCE", value = "BY_REFERENCE", valueType = "String",
      comment = "A parameter or return of a function is passed by reference which means an address is used behind the scenes"),
    Constant(name = "BY_SHARING", value = "BY_SHARING", valueType = "String",
    ...
    Constant(name = "BY_VALUE", value = "BY_VALUE", valueType = "String",
