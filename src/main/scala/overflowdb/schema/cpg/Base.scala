...
object Base {
  ...
  class Schema(builder: SchemaBuilder) {
    ...
    // node types
    lazy val metaData: NodeType = builder
      .addNodeType(
        name = "META_DATA",
    ...
    lazy val file: NodeType = builder
      .addNodeType(
        name = "FILE",
    ...
    lazy val method: NodeType = builder
      .addNodeType(
        name = "METHOD",
    ...
    lazy val methodParameterIn: NodeType = builder
      .addNodeType(
    ...
    lazy val methodReturn: NodeType = builder
      .addNodeType(
        name = "METHOD_RETURN",
    ...
    lazy val modifier: NodeType = builder
      .addNodeType(
        name = "MODIFIER",
    ...
    lazy val typeDecl: NodeType = builder
      .addNodeType(
        name = "TYPE_DECL",
    ...
    lazy val typeParameter: NodeType = builder
      .addNodeType(
        name = "TYPE_PARAMETER",
    ...
    lazy val typeArgument: NodeType = builder
      .addNodeType(
        name = "TYPE_ARGUMENT",
    ...
    lazy val member: NodeType = builder
      .addNodeType(
        name = "MEMBER",
    ...
    lazy val namespaceBlock: NodeType = builder
      .addNodeType(
    ...
    lazy val literal: NodeType = builder
      .addNodeType(
        name = "LITERAL",
    ...
    lazy val callNode: NodeType = builder
      .addNodeType(
        name = "CALL",
    ...
    lazy val local: NodeType = builder
      .addNodeType(
        name = "LOCAL",
    ...
    lazy val identifier: NodeType = builder
      .addNodeType(
        name = "IDENTIFIER",
    ...
    lazy val fieldIdentifier: NodeType = builder
      .addNodeType(
    ...
    lazy val block: NodeType = builder
      .addNodeType(
        name = "BLOCK",
    ...
    lazy val methodInst: NodeType = builder
      .addNodeType(
        name = "METHOD_INST",
        comment =
    ...
    lazy val arrayInitializer: NodeType = builder
      .addNodeType(
    ...
    lazy val methodRef: NodeType = builder
      .addNodeType(
        name = "METHOD_REF",
    ...
    lazy val typeRef: NodeType = builder
      .addNodeType(
        name = "TYPE_REF",
    ...
    lazy val controlStructure: NodeType = builder
      .addNodeType(
    ...
    lazy val jumpTarget: NodeType = builder
      .addNodeType(
        name = "JUMP_TARGET",
    ...
    lazy val unknown: NodeType = builder
      .addNodeType(
        name = "UNKNOWN",
