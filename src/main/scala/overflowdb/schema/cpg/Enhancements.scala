...
object Enhancements {
  ...
  class Schema(builder: SchemaBuilder, base: Base.Schema) {
    ...
    // node types
    lazy val binding: NodeType = builder.addNodeType(
      name = "BINDING",
    ...
    lazy val implicitCall: NodeType = builder.addNodeType(
      name = "IMPLICIT_CALL",
    ...
    lazy val postExecutionCall: NodeType = builder.addNodeType(
    ...
    lazy val tag: NodeType = builder.addNodeType(
      name = "TAG",
    ...
    lazy val namespace: NodeType = builder.addNodeType(
      name = "NAMESPACE",
    ...
    lazy val methodParameterOut: NodeType = builder.addNodeType(
