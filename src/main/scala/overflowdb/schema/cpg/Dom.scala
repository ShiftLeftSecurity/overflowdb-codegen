...
object Dom {
  def apply(builder: SchemaBuilder, base: Base.Schema, enhancements: Enhancements.Schema, javaSpecific: JavaSpecific.Schema) =
    new Schema(builder, base, enhancements, javaSpecific)

  class Schema(builder: SchemaBuilder, base: Base.Schema, enhancements: Enhancements.Schema, javaSpecific: JavaSpecific.Schema) {
    import base._
    import javaSpecific._
    import enhancements._

    // node types
    lazy val domNode: NodeType = builder.addNodeType(
      name = "DOM_NODE",
    ...
    lazy val domAttribute: NodeType = builder.addNodeType(
      name = "DOM_ATTRIBUTE",
