...
object JavaSpecific {
  ...
  class Schema(builder: SchemaBuilder, base: Base.Schema, enhancements: Enhancements.Schema) {
    ...
    // node types
    lazy val annotation: NodeType = builder
      .addNodeType(
        name = "ANNOTATION",
    ...
    lazy val annotationParameterAssign: NodeType = builder
      .addNodeType(
    ...
    lazy val annotationParameter: NodeType = builder
      .addNodeType(
    ...
    lazy val annotationLiteral: NodeType = builder
      .addNodeType(
    ...
    lazy val configFile: NodeType = builder
      .addNodeType(
        name = "CONFIG_FILE",
